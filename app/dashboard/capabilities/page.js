...
import { Code2, Database, Film, Globe, Image as ImageIcon, MessageSquare, Mic, Music, Settings, ShieldAlert, User, Video, Zap } from 'lucide-react'
              ...
              {group.items.map((item) => (
                <div key={item.name} className="rounded-lg border border-white/[0.06] bg-black/20 p-3">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <Badge variant="outline" className="border-cyan-500/30 text-cyan-300 text-[9px]">Visible in Studio</Badge>
