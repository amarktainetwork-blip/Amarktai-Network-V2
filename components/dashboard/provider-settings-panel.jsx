              ...
              <div key={provider.providerKey} className="rounded-md border border-white/[0.06] bg-black/20 p-4">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  <div className="min-w-0">
                    ...
                    {isMimo && <p className="mt-2 text-xs text-amber-200/80">MiMo is configured for coding-tool use only. Backend runtime, worker jobs, and fallback execution are disabled. Use MiMo only through a secure server-side coding tool or terminal session in the future coder/workbench app.</p>}
                  </div>
