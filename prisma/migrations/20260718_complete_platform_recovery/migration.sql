...
ALTER TABLE `model_registry_entries` MODIFY `structured_output_modes` LONGTEXT NOT NULL DEFAULT '[]', MODIFY `supported_parameters` LONGTEXT NOT NULL DEFAULT '[]';
...
ALTER TABLE `app_ai_profiles` MODIFY `business_context` LONGTEXT NOT NULL DEFAULT '{}', MODIFY `product_instructions` LONGTEXT NOT NULL DEFAULT '', MODIFY `default_route_pool` LONGTEXT NOT NULL DEFAULT '[]';
...
ALTER TABLE `app_capability_grants` MODIFY `preferred_pool` LONGTEXT NOT NULL DEFAULT '[]', MODIFY `selectable_allowlist` LONGTEXT NOT NULL DEFAULT '[]', MODIFY `restricted_pool` LONGTEXT NOT NULL DEFAULT '[]', MODIFY `workflow_step_overrides` LONGTEXT NOT NULL DEFAULT '{}';
...
ALTER TABLE `voice_library` MODIFY `compatible_models` LONGTEXT NOT NULL DEFAULT '[]', MODIFY `use_case_tags` LONGTEXT NOT NULL DEFAULT '[]';
