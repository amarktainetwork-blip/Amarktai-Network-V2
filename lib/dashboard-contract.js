...
export const PROVIDER_CONTRACTS = [
  ...
  },
  {
    ...
    proofStatus: 'not_live_proven',
    finalProvider: true,
    description: 'Final coding and reasoning provider; backend runtime requires an explicitly allowed credential policy.',
...
export const DASHBOARD_PAGES = [
  ...
  { id: 'repo-workbench', href: '/dashboard/repo-workbench', label: 'Repo Workbench', icon: 'GitPullRequest' },
