...
export const PROVIDER_CONTRACTS = [
  ...
  },
  {
    ...
    description: 'Gated/uncensored provider lane and fallback model infrastructure where explicitly allowed.',
...
export const DASHBOARD_PAGES = [
  ...
  { id: 'providers', href: '/dashboard/providers', label: 'Providers', icon: 'Cpu' },
