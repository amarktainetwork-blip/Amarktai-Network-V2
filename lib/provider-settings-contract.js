...
export function getHealthStatusClasses(healthStatus) {
  if (healthStatus === 'healthy') return 'border-emerald-500/30 text-emerald-300'
  if (healthStatus === 'configured') return 'border-cyan-500/30 text-cyan-300'
  if (healthStatus === 'disabled') return 'border-amber-500/30 text-amber-300'
  if (healthStatus === 'error') return 'border-rose-500/30 text-rose-300'
