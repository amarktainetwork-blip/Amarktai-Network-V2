...
export const NAV = [
  ...
  { href: '/dashboard/jobs', label: 'Jobs & Artifacts', icon: 'Activity' },
  { href: '/dashboard/app-gateway', label: 'App Gateway', icon: 'Plug' },
  { href: '/dashboard/providers', label: 'Providers & Models', icon: 'Cpu' },
  { href: '/dashboard/agents', label: 'Agents & Learning', icon: 'Bot' },
